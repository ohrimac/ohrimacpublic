...
sleep 60
launchctl asuser "$uid" sudo -u "$currentUser" santactl rule --block --sha256 bd0ed4aa414239048b31e3f97a0e103f05232ab4955b57c40b514990885fc33f
launchctl asuser "$uid" sudo -u "$currentUser" santactl rule --block --sha256 2cc2cf0b8794f80b913bb6189d4b3290c33fc296e23dc5e40b32f8be72b58060
exit
